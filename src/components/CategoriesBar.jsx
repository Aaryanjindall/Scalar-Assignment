...
const categories = [
  { name: 'For You', icon: 'https://rukminim2.flixcart.com/flap/128/128/image/29327f40e9c4d26b.png' }, // Top Offers
    ...
    <div className="w-full bg-white px-4 md:px-0 shadow-sm border-b border-gray-100 hidden md:block">
      <div className="max-w-[1248px] mx-auto flex items-center justify-between py-3 overflow-x-auto no-scrollbar gap-6">
        {categories.map((cat, idx) => (
          <Link key={cat.name} href={`/?category=${cat.name}`} className="flex flex-col items-center justify-center min-w-[70px] group cursor-pointer">
